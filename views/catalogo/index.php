...
<section class="flex gap-6 px-6 max-w-screen-xl mx-auto">
    <!-- filtros -->
    <div class="w-1/4">
        <form action="catalogo.php" method="GET" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <input type="number" name="km_min" placeholder="Mínimo"
                        class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring focus:ring-red-200">
                    <input type="number" name="km_max" placeholder="Máximo"
                        class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring focus:ring-red-200">
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <label class="inline-flex items-center">
                            <input type="radio" name="estado" value="todos" class="form-radio h-4 w-4 text-red-600">
        ...
        <ul class="grid min-[480px]:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-3 lg:gap-x-5">
            <?php foreach ($vehiculos as $vehiculo): ?>
                ...
                <li class="flex flex-col gap-2 rounded-xl">
                    ...
                    <div class="px-1">
                        <h2
                            class="text-xl font-semibold text-gray-800 hover:text-red-600 transition-colors duration-300 cursor-pointer">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-1 mt-2">
                            <p class="text-gray-500 text-lg font-medium">
                                <?php echo "$" . number_format($vehiculo->precio, 2) . " USD" ?>
                            </p>
