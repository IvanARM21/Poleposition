        ...
        <table class="min-w-[800px] w-full caption-bottom border-b border-gray-200">
            <thead>
                <tr class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-820">
                    <th class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-820">ID (Compra)
                    </th>
                    ...
                    <th class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-200">
                        Kilometraje</th>
                    <th class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-820">Año
                    </th>
                    <th class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-200">Tipo
                    </th>
            ...
            <tbody class="divide-y divide-gray-200">
                <?php foreach ($historial as $historialventas): ?>
                    <tr>
                        <td class="px-1 py-4 sm:p-4 text-gray-600 font-medium"><?php echo $historialventas->idCompra; ?></td>
...
<?php else: ?>
    <p class="text-xl text-gray-500">Aún no tienes <span class="text-red-600 font-medium hover:underline decoration-1"
            id="spanModal">ninguna venta</span></p>
<?php endif; ?>