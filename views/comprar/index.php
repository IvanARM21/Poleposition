            ...
            <div class="rounded-xl">
                <div>
                    ...
                    <div class="flex flex-col gap-1 mt-5">
                        ...
                        <input id="email" name="email" type="email" class="w-full py-2 px-4 border rounded-md" value="<?= htmlspecialchars($email) ?>">
                ...
                <div class="mt-2 pt-2 border-t">
                    ...
                    <div class="flex flex-col gap-3 mt-2">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="flex flex-col gap-1">
                                <label for="nombre" class="text-lg text-gray-700">Nombre <span class="text-red-600">*</span> </label>
                                <input type="text" id="nombre" name="nombre" class="w-full py-2 px-4 border rounded-md" value="<?= htmlspecialchars($nombre) ?>">
                            ...
                            <div class="flex flex-col gap-1">
                                <label for="apellido" class="text-lg text-gray-700">Apellido <span class="text-red-600">*</span> </label>
                                <input type="text" id="apellido" name="apellido" class="w-full py-2 px-4 border rounded-md" value="<?= htmlspecialchars($apellido) ?>">
                        ...
                        <div class="flex flex-col gap-1">
                            <label for="direccion" class="text-lg text-gray-700">Dirección <span class="text-red-600">*</span> </label>
                            <input type="text" id="direccion" name="direccion" class="w-full py-2 px-4 border rounded-md">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" id="apartamento" name="apartamento" class="w-full py-2 px-4 border rounded-md">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div class="flex flex-col gap-1">
                                <label for="ciudad" class="text-lg text-gray-700">Ciudad <span class="text-red-600">*</span> </label>
                            ...
                            <div class="flex flex-col gap-1">
                                <label for="codigo" class="text-lg text-gray-700">Código Postal <span class="text-red-600">*</span> </label>
                            ...
                            <div class="flex flex-col gap-1">
                                <label for="pais" class="text-lg text-gray-700">País <span class="text-red-600">*</span> </label>
                        ...
                        <div class="flex flex-col gap-1">
                            <label for="telefono" class="text-lg text-gray-700">Teléfono <span class="text-red-600">*</span> </label>
                    ...
                    <div class="mt-2 pt-2 border-t">
                        ...
                        <div class="flex flex-col gap-3 mt-2">
                            <div class="flex flex-col gap-1">
                                <label for="tarjeta" class="text-lg text-gray-700">Número de Tarjeta <span class="text-red-600">*</span> </label>
                                <input type="text" id="tarjeta" name="tarjeta" class="w-full py-2 px-4 border rounded-md">
                                <?php if (!empty($errors['tarjeta'])): ?>
                                    <p class="text-red-600"><?= htmlspecialchars($errors['tarjeta']) ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="flex flex-col gap-1">
                                <label for="nombreTarjeta" class="text-lg text-gray-700">Nombre en Tarjeta <span class="text-red-600">*</span> </label>
                                <input type="text" id="nombreTarjeta" name="nombreTarjeta" class="w-full py-2 px-4 border rounded-md">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <div class="flex flex-col gap-1 col-span-3">
                                    <label for="caducidad" class="text-lg text-gray-700">Fecha de Caducidad (MM/AA) <span class="text-red-600">*</span> </label>
                                    <input type="text" id="caducidad" name="caducidad" class="w-full py-2 px-4 border rounded-md">
                                    <?php if (!empty($errors['caducidad'])): ?>
                                        <p class="text-red-600"><?= htmlspecialchars($errors['caducidad']) ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="flex flex-col gap-1 col-span-1">
                                    <label for="cvc" class="text-lg text-gray-700">CVC <span class="text-red-600">*</span> </label>
            ...
            <div class="flex flex-col gap-5 lg:sticky top-5 h-[581px]">
                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="flex flex-col">
                        ...
                        <button type="submit" id="confirmBtn" class="bg-red-600 font-medium text-lg w-full py-2 px-4 text-white rounded-xl border-t mt-4">
                            Confirmar compra
                        </button>
                    </div>
                </div>
