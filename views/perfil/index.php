        ...
        <table class="min-w-[800px] w-full caption-bottom border-b border-gray-200">
            <thead>
                <tr class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800 border-gray-820">
                    ...
                    <th class="border-b px-4 py-3.5 text-left text-lg font-semibold text-gray-800">Kilometraje</th>
            ...
            <tbody class="divide-y divide-gray-200">
                <?php if (empty($compras)): ?>
                    <tr>
                        <td colspan="9" class="px-1 py-4 text-center text-gray-600 font-medium">No existe ninguna compra o alquiler.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($compras as $compra): ?>
                        <tr>
                            <td class="px-1 py-4 sm:p-4 text-gray-600 font-medium text-nowrap"><?php echo $compra->Nombre; ?></td>
                            ...
                            <td class="px-1 py-4 sm:p-4 text-gray-600 font-medium text-nowrap"><?php echo $compra->Fecha; ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
